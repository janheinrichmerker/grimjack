...
%- Investigate query drift for comparative synonyms query expansion
%- Chaeck bibliography: "Overview of touché 2020" vs "Overview of Touché 2022" (i.e. "Overview of Touché 2022" -> "Overview of touché 2022").
%- Is the stance classification corpus by Bondarenko et al. used? I am not fully sure, but in case you use it, please cite bondarenko:2022a from the additional bib-entries below.
...
\footnote{\url{https://tira.io}} that automatically evaluates submitted approaches and presents the results on a leaderboard.%\footnote{\url{https://tira.io/task/touche-task-2/dataset/touche-2022-task2}}
