...
\begin{frame}{Task at hand}  
  ...
  \begin{figure}
      \centering
      \includegraphics[height=5cm, width=8cm]{figures/touche.jpeg}
      % Source: https://mobile.twitter.com/webis_de/status/1468529926026534913?cxt=HHwWgoC97fyLouEoAAAA
  \end{figure}
\end{frame}
...
\begin{frame}{General approach}
  \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Many IR libabries avaiable 
    \end{itemize}
...
\begin{frame}{Argument quality tagging}
    \begin{itemize}
        ...
        \item We use the IBM Debater API~\cite{ToledoG2019} to get the argument quality
        \item Returns a score between 0 and 1
...
\begin{frame}{Argument stance tagging}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Convert T0s output to numbers
        \end{itemize}
    \end{itemize}
\end{frame}
