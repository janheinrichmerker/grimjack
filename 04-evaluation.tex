...
\todo{Maybe evaluate T0 stance on the stance dataset provided by the organizzers? We couold reference this in the description of the T0-run above.}
...
\todo{Repeat manual evaluation with runs \emph{Fair Re-ranking and Argumentative Axioms} and \emph{All You Need is T0}.}
