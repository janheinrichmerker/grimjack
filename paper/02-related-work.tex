...
In search engines, people often ask questions like \query{Is \emph{X} better than \emph{Y} with respect to \emph{Z}?}
...
\todo{ChatNoir uses BM25F.~\cite{PotthastHSGMTW2012}}
...
Team Inigo Montoya, second place in 2020, queries ChatNoir~\cite{BevendorffSHP2018} with the original queries and processes the first 20 results further.
