...
In 2020 the task was to retrieve documents from the ClueWeb12 corpus to answer comparative questions like \query{Is X better than Y with respect to Z?}.
...
We now will have a look at the two best runs regarding the \nDCG@5: Team Katana and Team Thor~\cite{BondarenkoGFBAPBSWPH2021}
