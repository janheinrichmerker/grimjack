\begin{figure}
    ...
    \begin{tikzpicture}[
        ...
        \node [block,dashed] (fairness-reranking) at (2,4) {Stance-based Re-ranking};
...
ranking
	...
	\caption{Architecture overview for the modular retrieval pipeline used to produce our runs. Dashed boxes indicate optional steps, that are not used in all runs.}
