...
from grimjack.model import Query, RankedDocument
from grimjack.model.axiom import Axiom
from grimjack.model.axiom.utils import (
    all_query_terms_in_documents,
    strictly_greater, strictly_less,
    average_smallest_span,
    closest_grouping_size_and_count,
    same_query_term_subset,
    average_between_query_terms
)
