...
Our results indicate that BM25 outperforms query likelihood ranking for initial passage retrieval and that stance-based re-ranking can slightly improve a ranking effectiveness.
Stance classification by prompting the T0 zero-shot language model is the best-performing approach in the shared task.
\end{abstract}
